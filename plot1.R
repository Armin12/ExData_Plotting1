...
hist_data=as.numeric(levels(household_power_consumption_twodays$Global_active_power))[household_power_consumption_twodays$Global_active_power]
hist(hist_data,col="red",xlab="Global Active Power (kilowatts)",main="Global Active Power")
