...
plot_data1=as.numeric(levels(household_power_consumption_twodays$Sub_metering_1))[household_power_consumption_twodays$Sub_metering_1]
plot_data2=as.numeric(levels(household_power_consumption_twodays$Sub_metering_2))[household_power_consumption_twodays$Sub_metering_2]
plot_data3=household_power_consumption_twodays$Sub_metering_3


plot(plot_data1,col="black",ylab="Energy sub metering",type="l",xlab="",xaxt = "n")
lines(plot_data2,col="red",ylab="Energy sub metering",type="l",xlab="",xaxt = "n")
lines(plot_data3,col="blue",ylab="Energy sub metering",type="l",xlab="",xaxt = "n")
